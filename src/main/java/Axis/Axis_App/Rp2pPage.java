...
public class Rp2pPage extends BasePage {
...
// locators 
	...
	public static By Sendtitle=By.xpath("//android.view.View[@index='1']");
	public static By Amounttxtbox =By.xpath("//android.widget.EditText[@index='1']");
	static String decimalnumber="1.5";
	static String Intnumber="1";
	public static By Mobiletxtbox =By.xpath("//android.widget.EditText[@index='3']");
	static String MobileNumber="01001009000";
	public By Desctxtbox =By.xpath("//android.widget.EditText[@text='Description']");
	String Desctxt="test";
	public static By ReviewRequestbtn =By.xpath("//android.widget.Button[@content-desc=\"Review request\"]");
	...
	public static By confirmationAmountlbl=By.xpath("//android.view.View[@index='3']");
